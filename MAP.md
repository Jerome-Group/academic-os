...
| Calendar CLI | Previewed Owned-calendar setup and pull-only forward Refresh into atomic private mirrors | `src/calendar/`, `src/commands/calendar-*-command.ts`, `docs/operator-guide.md` |
