...
| Tasks CLI | Previewed per-module Google Tasks list provisioning and pull-only register refresh for one module or the cohort | `src/tasks/`, `src/commands/tasks-*-command.ts`, `docs/operator-guide.md` |
