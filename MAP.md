...
| Calendar CLI | Previewed Owned-calendar setup, resilient pull-only Refresh, and private conflict-checked create Proposals | `src/calendar/`, `src/commands/calendar-*-command.ts`, `docs/operator-guide.md` |
