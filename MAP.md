...
| Module CLI | Previewed journalled/resumable seeding, active-cohort and migration audit, append-only private observations, pure conformance, and reports | `src/cli.ts` |
