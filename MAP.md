...
| Calendar CLI | Previewed Owned-calendar setup and resilient pull-only Refresh into per-calendar atomic private state | `src/calendar/`, `src/commands/calendar-*-command.ts`, `docs/operator-guide.md` |
...
`CONTEXT.md` and `docs/adr/0006-…`; setup and pull-only Refresh are implemented Calendar paths.
